...
class BukuTutukDestpek extends StatefulWidget {
  const BukuTutukDestpek({Key? key}) : super(key: key);

  @override
  State<BukuTutukDestpek> createState() => _BukuTutukDestpekState();
}

class _BukuTutukDestpekState extends State<BukuTutukDestpek> {
  String navCiroke = "Bûk û Tûtûk";
  String agahi = "Qala keçekî reben dike.";
  bool weneheye = false;
  ...
  Future<String?> linkUrl() async {
    try {
      ...
      final storageRef2 = await FirebaseStorage.instance
          .ref("ciroks/wene/1/bukututuk1.jpg")
          .getDownloadURL();
