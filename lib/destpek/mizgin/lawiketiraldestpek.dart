...
class LawikeTiralDestpek extends StatefulWidget {
  const LawikeTiralDestpek({Key? key}) : super(key: key);

  @override
  State<LawikeTiralDestpek> createState() => _LawikeTiralDestpekState();
}

class _LawikeTiralDestpekState extends State<LawikeTiralDestpek> {
  String navCiroke = "Lawikê Tiral";
  String agahi = "Qala lawikê tiral û bavê wî dike.";
  bool weneheye = false;
  ...
  Future<String?> linkUrl() async {
    try {
      ...
      final storageRef2 = await FirebaseStorage.instance
          .ref("ciroks/wene/1/lawiketiral1.png")
          .getDownloadURL();
