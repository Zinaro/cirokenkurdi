...
class SampiyonenCarqevazkanDestpek extends StatefulWidget {
  const SampiyonenCarqevazkanDestpek({Key? key}) : super(key: key);

  @override
  State<SampiyonenCarqevazkanDestpek> createState() =>
      _SampiyonenCarqevazkanDestpekState();
}

class _SampiyonenCarqevazkanDestpekState
    extends State<SampiyonenCarqevazkanDestpek> {
  String navCiroke = "Şampiyonên Çarqevazkan";
  String agahi = "Qala pêşbirka sê ajalan dike.";
  bool weneheye = false;
  ...
  Future<String?> linkUrl() async {
    try {
      ...
      final storageRef2 = await FirebaseStorage.instance
          .ref("ciroks/wene/1/2Fsampiyonencarqevazkan1.png")
          .getDownloadURL();
