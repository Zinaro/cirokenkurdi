...
class SereMiheDestpek extends StatefulWidget {
  const SereMiheDestpek({Key? key}) : super(key: key);

  @override
  State<SereMiheDestpek> createState() => _SereMiheDestpekState();
}

class _SereMiheDestpekState extends State<SereMiheDestpek> {
  String navCiroke = "Serê Mîhê";
  String agahi = "Qala derewên lawikekî dike.";
  bool weneheye = false;
  ...
  Future<String?> linkUrl() async {
    try {
      ...
      final storageRef2 = await FirebaseStorage.instance
          .ref("ciroks/wene/1/seremihe1.jpg")
          .getDownloadURL();
