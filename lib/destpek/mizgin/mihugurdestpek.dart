...
class MihuGurDestpek extends StatefulWidget {
  const MihuGurDestpek({Key? key}) : super(key: key);

  @override
  State<MihuGurDestpek> createState() => _MihuGurDestpekState();
}

class _MihuGurDestpekState extends State<MihuGurDestpek> {
  String navCiroke = "Mîh û Gur";
  String agahi = "Qala mîh û gur dike";
  bool weneheye = false;
  ...
  Future<String?> linkUrl() async {
    try {
      ...
      final storageRef2 = await FirebaseStorage.instance
          .ref("ciroks/wene/1/mihugur1.png")
          .getDownloadURL();
