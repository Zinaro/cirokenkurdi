...
class SeruMiskDestpek extends StatefulWidget {
  const SeruMiskDestpek({Key? key}) : super(key: key);

  @override
  State<SeruMiskDestpek> createState() => _SeruMiskDestpekState();
}

class _SeruMiskDestpekState extends State<SeruMiskDestpek> {
  String navCiroke = "Şêr û Mişk";
  String agahi = "Qala şêr û mişkê reben dike.";
  bool weneheye = false;
  ...
  Future<String?> linkUrl() async {
    try {
      ...
      final storageRef2 = await FirebaseStorage.instance
          .ref("ciroks/wene/1/serumisk1.jpg")
          .getDownloadURL();
