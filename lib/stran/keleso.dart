...
class Keleso extends StatefulWidget {
  const Keleso({Key? key}) : super(key: key);

  @override
  State<Keleso> createState() => _KelesoState();
}

class _KelesoState extends State<Keleso> {
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              'https://firebasestorage.googleapis.com/v0/b/ciroken-kurdi.appspot.com/o/stran%2Fwene%2Fzaroktv-keleso.jpg?alt=media&token=7a983d97-9d75-4d02-9175-88e77374aee2',
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
