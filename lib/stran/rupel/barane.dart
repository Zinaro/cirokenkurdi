...
class BaraneRupel extends StatefulWidget {
  const BaraneRupel({super.key});

  @override
  State<BaraneRupel> createState() => _BaraneRupelState();
}

class _BaraneRupelState extends State<BaraneRupel> {
